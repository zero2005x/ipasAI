...
TERM_CONTEXT_GUARD = {
    "通過": {
        "allow": r"(三讀通過|表決通過|審議通過|通過考試|通過測驗|通過驗收|通過審查|通過評鑑|通過認證|經[^\n]{0,12}通過|決議通過|議會通過|立法院通過|核定通過|票通過)",
        "message": "「通過」若表『透過』義須改；若表『三讀通過／考試通過』等則保留",
    },
    "檢測": {
        "allow": r"(瑕疵檢測|異常檢測|檢測器|檢測模型|檢測率|物件檢測|檢測到)",
        "message": "「檢測」若指人臉／物件偵測須改為「偵測」；固定術語可保留",
    },
    "水平": {
        "allow": r"(水平線|水平面|水平軸|水平方向)",
        "message": "「水平」若表『水準／品質』義須改",
    },
    "提取": {
        "allow": r"(提取率)",
        "message": "「提取」應改為「擷取」",
